...
| :--- | :--- |
| **Mobile Engineering** | Flutter & Dart, Native SDK Integration, Advanced State Management (BLOC, Riverpod), Offline-First Architectures (SQLite) |
| **Backend & Real-Time** | Node.js (Express), Prisma ORM, PostgreSQL, WebRTC, Mediasoup, Socket.io, Redis, BullMQ |
| **AI & Cloud Ecosystem** | OpenAI API, Google ML Kit, Google Cloud Platform (GCP), Firebase Enterprise Services |
| **DevOps & Strategy** | CI/CD Pipelines, Docker, App Store/Play Store Compliance, Agile/Scrum |
